...
def PrintCameraParam(stCameraParam):
    ...
    print("--------")
    for i in range(0,9):
        print("Depth Intrinsic[%d]: %.10f" % (i, stCameraParam.stDepthCalibInfo.stIntrinsic.fData[i]))
    print("--------")
    for i in range(0,12):
        print("Depth Distortion[%d]: %.10f" % ( i, stCameraParam.stDepthCalibInfo.stDistortion.fData[i]))
    ...
    print("--------")
    for i in range(0,9):
        print("Rgb Intrinsic[%d]: %.10f" % (i, stCameraParam.stRgbCalibInfo.stIntrinsic.fData[i]))
    print("--------")
    for i in range(0,12):
        print("Rgb Distortion[%d]: %.10f" % (i, stCameraParam.stRgbCalibInfo.stDistortion.fData[i]))
    print("-------- Depth to Rgb Extrinsic --------")
    for i in range(0,16):
        print("Depth to Rgb Extrinsic[%d]: %.10f" % (i, stCameraParam.stDepth2RgbExtrinsic.fData[i]))
    print("--------")
    return
...
if __name__ == "__main__":
    ...
    # ch:按任意键退出 | en:Press any key to quit
