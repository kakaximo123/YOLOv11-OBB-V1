...
# 💚💚💚💚💚💚
# Mv3dRgbdDll = ctypes.WinDLL("./Mv3dRgbdImport/Mv3dRgbd.dll",winmode=0)
# 💚💚💚💚💚💚
# 💙💙💙💙💙
# 获取当前文件夹（Mv3dRgbdApi.py 所在目录）
current_dir = os.path.dirname(__file__)

# 拼接 DLL 的绝对路径
dll_path = os.path.join(current_dir, "Mv3dRgbd.dll")
dll_path = os.path.abspath(dll_path)

print("加载 DLL:", dll_path)  # 调试用

Mv3dRgbdDll = ctypes.WinDLL(dll_path, winmode=0)
# 💙💙💙💙💙
class Mv3dRgbd():
    def __init__(self):
